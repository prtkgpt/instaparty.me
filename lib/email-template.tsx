...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f3f4f6;">
  <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #f3f4f6; padding: 40px 0;">
    <tr>
      <td align="center">
        <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background: linear-gradient(135deg, #9333ea 0%, #ec4899 100%); border-radius: 16px; overflow: hidden; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1);">
          <!-- Header -->
          <tr>
            <td style="padding: 40px 40px 30px; text-align: center;">
              <h1 style="margin: 0; font-size: 48px; color: white;">🎉</h1>
          ...
          <tr>
            <td style="background-color: white; padding: 40px;">
              ...
              <table role="presentation" style="width: 100%; border-collapse: collapse; margin: 40px 0 20px;">
                <tr>
                  <td align="center">
                    <a href="${inviteUrl}" style="display: inline-block; background: linear-gradient(135deg, #9333ea 0%, #ec4899 100%); color: white; text-decoration: none; padding: 16px 32px; border-radius: 12px; font-weight: 600; font-size: 18px; box-shadow: 0 4px 6px rgba(147, 51, 234, 0.3);">
                      RSVP Now
                    </a>
                  </td>
                </tr>
              ...
              <p style="margin: 30px 0 0; font-size: 14px; color: #9ca3af; text-align: center;">
                ...
                <a href="${inviteUrl}" style="color: #9333ea; word-break: break-all;">${inviteUrl}</a>
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0; font-size: 12px; color: #9ca3af;">
                Sent via <a href="https://www.instaparty.me" style="color: #9333ea; text-decoration: none; font-weight: 600;">InstaParty</a>
              </p>
